...
//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("AdcValueFile")
#else
#pragma DATA_SECTION(AdcValue,"AdcValueFile");
#endif
volatile struct ADC_VALUE AdcValue;
volatile struct ADC_VALUE AdcValue2;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("SvmValueFile")
#else
