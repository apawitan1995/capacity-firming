...
extern void ConfigEPwm3(void);
#if DSP28_EPWM4
extern void ConfigEPwm4(void);
#endif // endif DSP28_EPWM4
#if DSP28_EPWM5
extern void ConfigEPwm5(void);
#endif // endif DSP28_EPWM5
#if DSP28_EPWM6
extern void ConfigEPwm6(void);
#endif // endif DSP28_EPWM6
extern void ConfigTz(void);
extern void StartEPwm(void);
extern void StopEPwm(void);
...
extern void ConfigEQep(void);
extern void ConfigEQep1(void);
extern void ConfigEQep2(void);
...
extern void macro_print(char*, ...);
extern void revstr(char*);
extern int istr(char*, int);
extern int fstr(char*, float, int);
